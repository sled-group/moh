...
python main.py --model_name yivl --model_size "6b" --model_path /<your-path>/ROPE/Yi-VL-6B-hf --device_map cuda:0 --data_base_path /<your-path>/ROPE/ROPE --output_base_path /<your-path>/ROPE/output
